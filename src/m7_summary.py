...
blue_sue = rg.SimpleTurtle()
blue_sue.pen = rg.Pen('blue',5)

blue_sue.left(90)
blue_sue.forward(200)

blue_sue.pen_up()
location = rg.Point(100,-40)
blue_sue.go_to(location)
blue_sue.pen_down()

blue_sue.pen = rg.Pen('green',10)
blue_sue.backward(150)
